...
process.MINIAODSIMEventContent.outputCommands.extend(["keep *_photonMVAIDProducerEB*_*_*","keep *_electronMVAIDProducerHGCal*_*_*", "keep *_photonMVAIDProducerHGCal*_*_*", "keep *_electronMVAIDProducerEB*_*_*"])
...
from MyTools.EDProducers.egammaIDProducerEB_cfi import *
process = customize_eleEBID(process = process)
process = customize_phoEBID(process = process)

from MyTools.EDProducers.egammaIDProducerHGCal_cfi import *
process = customize_eleHGCalID(process = process)
process = customize_phoHGCalID(process = process)
...
process.phase2EgammaID = cms.Path(process.eleEBID_seq*
                                  process.phoEBID_seq*
                                  process.eleHGCalID_seq*
                                  process.phoHGCalID_seq)
# Schedule definition
process.schedule = cms.Schedule(process.raw2digi_step,process.L1Reco_step,process.reconstruction_step,process.recosim_step,process.Flag_HBHENoiseFilter,process.Flag_HBHENoiseIsoFilter,process.Flag_CSCTightHaloFilter,process.Flag_CSCTightHaloTrkMuUnvetoFilter,process.Flag_CSCTightHalo2015Filter,process.Flag_globalTightHalo2016Filter,process.Flag_globalSuperTightHalo2016Filter,process.Flag_HcalStripHaloFilter,process.Flag_hcalLaserEventFilter,process.Flag_EcalDeadCellTriggerPrimitiveFilter,process.Flag_EcalDeadCellBoundaryEnergyFilter,process.Flag_ecalBadCalibFilter,process.Flag_goodVertices,process.Flag_eeBadScFilter,process.Flag_ecalLaserCorrFilter,process.Flag_trkPOGFilters,process.Flag_chargedHadronTrackResolutionFilter,process.Flag_muonBadTrackFilter,process.Flag_BadChargedCandidateFilter,process.Flag_BadPFMuonFilter,process.Flag_BadPFMuonDzFilter,process.Flag_hfNoisyHitsFilter,process.Flag_BadChargedCandidateSummer16Filter,process.Flag_BadPFMuonSummer16Filter,process.Flag_trkPOG_manystripclus53X,process.Flag_trkPOG_toomanystripclus53X,process.Flag_trkPOG_logErrorTooManyClusters,process.Flag_METFilters,process.phase2EgammaID,process.endjob_step,process.MINIAODSIMoutput_step)
